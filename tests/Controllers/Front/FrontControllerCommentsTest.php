...
class FrontControllerCommentsTest extends WebTestCase
{
    ...
    {
        static::ensureKernelShutdown(); // to not Booting the kernel before calling 

        $client = static::createClient();
        $client->followRedirects();
        
        $crawler = $client->request('GET', '/post-details/16');
    ...
    public function testNewCommentAndNumberOfComments()
    {
        ...
        $crawler = $this->client->request('GET', '/post-details/16');
